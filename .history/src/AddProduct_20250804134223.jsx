...
const fetchHiscategory = async () =>{
  ...
  try{
    const Categoryresponse = await axios.get('https://mediatracker-dp6t.onrender.com/api/categories/his')
    setHiscategoryOption(Categoryresponse.data)
    console.log(Categoryresponse.data,"sethiscategory")
  }catch(error){
    console.log("error", error);
  }
}
